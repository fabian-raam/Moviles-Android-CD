    ...
    Scaffold(
        ...
        NavHost(
                ...
                HomeScreen(
                    onClassClick = { className ->
                        ...
                        navController.navigate(
                            Screen.ClassDetail.createRoute(encodedName)
                        )
                    }
                )
            }
            ...
            composable(
                ...
                val rawName =
                    backStackEntry.arguments?.getString("className") ?: ""
            ...
            composable(
                ...
                val rawSchedule =
                    backStackEntry.arguments?.getString("schedule") ?: ""

                val rawRoom =
                    backStackEntry.arguments?.getString("room") ?: ""
